...
import cc.qxt063.blockStorageSimulator.components.bpt.util.Utilities;
...
//       SearchResult sr = bt256.searchKey(1, false);
//       RangeResult rr = bt256.rangeSearch(1, 4, false);
...
//        SearchResult sr = bt1024.searchKey(37, false);
//        sr.getValues().forEach(x -> System.out.print(x.trim() + ","));
//        RangeResult rr = bt1024.rangeSearch(30, 40, false);
//        rr.getQueryResult().forEach(x -> System.out.printf("kv(%d,%s), ", x.getKey(), x.getValue().trim()));

        System.out.println("Total pages for bt1024 in the end: " + bt1024.getTotalTreePages());
        System.out.println("max page no for bt1024: " + bt1024.getMaxPageNumber());
        System.out.println("leaf node degree: " + btConf1024.getLeafNodeDegree());
        System.out.println("tree degree: " + btConf1024.getTreeDegree());
//        System.out.println("tree degree: " + btConf1024.);
